...
// class under test
const pathToRoot = '../../../../../apis/';
console.log(path.join(pathToRoot, 'fabric-contract-api/lib/jsontransactionserializer.js'));
console.log(require('fabric-contract-api/lib/jsontransactionserializer.js'));
console.log('==============================================================================');
